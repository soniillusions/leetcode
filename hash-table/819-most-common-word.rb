...
def most_common_word(paragraph, banned)
  ...
  words.each do |word|
    ...
    memo[word].nil? ? memo[word] = 1 : memo[word] += 1
  end
...
banned = %w[m i s w y d q l a p n t u b o e f g c x]
puts most_common_word(paragraph, banned)
